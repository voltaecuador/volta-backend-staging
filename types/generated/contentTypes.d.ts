...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    role: Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    clasesDisponibles: Attribute.Integer;
...
export interface ApiBicycleBicycle extends Schema.CollectionType {
  collectionName: 'bicycles';
  info: {
...
export interface ApiClassClass extends Schema.CollectionType {
  ...
  attributes: {
    nombreClase: Attribute.String;
    horaFin: Attribute.Time;
    diaDeLaSemana: Attribute.Enumeration<
      [
        'Lunes',
        'Martes',
        'Mi\u00E9rcoles',
